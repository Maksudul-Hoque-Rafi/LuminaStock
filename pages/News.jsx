        ...
        setArticles([
          {
            ...
            summary:
              "Unable to retrieve real-time news at this moment. Please check your connection or API key.",
            source: "System",
            time: "Now",
            url: "#",
          },
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-500">
            Real-time updates powered by Google Search.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading
          ...
          : articles.map((article, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all flex flex-col h-full"
              >
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3 leading-snug line-clamp-3">
                  {article.title}
                </h3>
                <p className="text-sm text-slate-600 mb-6 flex-grow line-clamp-4">
                  {article.summary}
                </p>
